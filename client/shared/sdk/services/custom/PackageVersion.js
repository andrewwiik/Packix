...
export class PackageVersionApi extends BaseLoopBackApi {
   ...
   * </em>
   */
   createFile(id, data, customHeaders) {
   ...
   * @param {any} id PackageVersion id
   *
   * @param {any} fk Foreign key for ratings
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
   findByIdRatings(id, fk, customHeaders) {
    
    let _method = "GET";
    let _url = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageVersions/:id/ratings/:fk";
    let _routeParams = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
   destroyByIdRatings(id, fk, customHeaders) {
   ...
   * </em>
   */
   updateByIdRatings(id, fk, data, customHeaders) {
  ...
  /**
   * Queries ratings of PackageVersion.
   *
   * @param {any} id PackageVersion id
   *
   * @param {object} filter 
   ...
   * </em>
   */
   getRatings(id, filter, customHeaders) {
    
    let _method = "GET";
    let _url = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageVersions/:id/ratings";
    let _routeParams = {
      id: id
    };
    let _postBody = {};
   ...
   * </em>
   */
   createRatings(id, data, customHeaders) {
   ...
   * This method returns no data.
   */
   deleteRatings(id, customHeaders) {
   ...
   * </em>
   */
   review(id, review, customHeaders) {
   ...
   * </em>
   */
   createManyFile(id, data, customHeaders) {
   ...
   * </em>
   */
   createManyRatings(id, data, customHeaders) {
